...
SlaveNeighborhoodThreadOld::SlaveNeighborhoodThreadOld(
...
SlaveNeighborhoodThreadOld::SlaveNeighborhoodThreadOld(SlaveNeighborhoodThreadOld & x,
                                                 Threads::split /*split*/)
  : _mesh(x._mesh),
 ...
 */
void
SlaveNeighborhoodThreadOld::operator()(const NodeIdRange & range)
{
...
void
SlaveNeighborhoodThreadOld::join(const SlaveNeighborhoodThreadOld & other)
{
